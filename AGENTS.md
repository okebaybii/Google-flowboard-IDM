...
- Maintain relative pathing for .Codex/docs references.

## 6. Additional Documentation
- [Architecture Detailed Overview](file:///.Codex/docs/architecture.md)
- [State Management Rules](file:///.Codex/docs/state_management.md)
- [Date & Allocation Logic](file:///.Codex/docs/date_logic.md)
