            ...
            for i, scene in enumerate(scenes):
                ...
                if use_source_frames and scene_frame:
                    ...
                    frame_fidelity_prefix = (
                        ...
                        "same body type and figure as the reference frame (same build, "
                        "curves, waist, hips and leg proportions — if the reference is "
                        "slim and sexy, keep it slim and sexy; do not slim it down or "
                        "bulk it up), the same natural body shape and proportions, the same body pose, "
